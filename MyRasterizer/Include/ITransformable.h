...
#pragma region Transformations
		...
		/// <returns></returns>
		ITransformable& translate(float p_x, float p_y, float p_z);
		...
		/// <returns></returns>
		ITransformable& translate(const Vec3& p_translation);
		...
		/// <returns></returns>
		ITransformable& scale(float p_x, float p_y, float p_z);
		...
		/// <param name="p_z">: local z axis</param>
		/// <returns></returns>
		ITransformable& rotateEulerAngles(const Rad& p_x, const Rad& p_y, const Rad& p_z);
		...
		/// <param name="p_z">: global z axis</param>
		/// <returns></returns>
		ITransformable& setPosition(float p_x, float p_y, float p_z);
		...
		/// <param name="p_z">: local z axis</param>
		/// <returns></returns>
		ITransformable& setScale(float p_x, float p_y, float p_z);
		...
		/// <param name="p_z">: local z axis</param>
		/// <returns></returns>
		ITransformable& setRotationEulerAngles(const Rad& p_x, const Rad& p_y, const Rad& p_z);
#pragma endregion


	protected:
		ITransformable(Mat4 p_transform);
